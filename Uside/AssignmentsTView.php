...
<head>
    ...
    <title>LearnLife  |   Assignments</title>
</head>
<body>
    ...
    <div id="page-content" class="mt-5">
        ...
        <h2 class="text-center pt-5">Assignments</h2>
            ...
            <hr class="bg-success">
            <div class="table-responsive ">
                <table class="table text-center table-bordered mr-2"  id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>Date & Time</th>
                            <th>Name</th>
...
var loader = function(e){
    ...
    $(document).ready(function(){
        $('#upload-box').submit(function(e){
            ...
            $.ajax({
                url:'../Dside/assignmentTupload.php',
                method:'POST',
    ...
    $(document).ready(function(){
     ...
     $.get("../Dside/AssignmentTLoad.php",function(data,flag){
