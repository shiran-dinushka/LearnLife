...
<body>
    ...
    <nav class=" col-md-12 bg-primary py-1 pl-5 ml-2 text-light position-fixed" id="upperbar" style=" z-index: 1071;">
            ...
            <h1 class="ml-5 float-left " style="font-family: 'Pattaya', sans-serif;">LearnLife</h1>
    ...
    <div class="container pr-0">
        <div class="row ">
        <div class="col-md-12 mt-5 text-center"><h2 class="text-center mt-5">Publish Note</h2></div>
        <div class="col-md-12 mt-5">
            
            <div class="row justify-content-center">
                <form id="n-box">
                    <div class="form-group">
                        <label  for="N_h">Headline</label>
                        <input type="text"  id="Nhead" class="form-control">  
                    </div>
                    
                    <div class="form-group">
                        <label  for="N_d">Notice</label>
                        <textarea  cols="50" rows="20" class="form-control" id="Nbody"></textarea>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-warning"  class="form-control" id="submit">Submit</button>
                    </div>   
                </form>
            </div> 
        </div>  
