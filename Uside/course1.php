    ...
    <div class="row  mx-0">
        ...
        <div class="col-lg-12 " style="background-color:rgba(192, 192, 192, 0.123);">
            <nav class="navbar navbar-expand-md navbar-light " >
              <a class="navbar-brand ml-5" href="../"><h1 style="font-family: 'Pattaya', sans-serif;">LeanLife</h1></a>
  ...
  <!--image-->   
    ...
    <section>
      <div class="container pt-5">
          <h1 class="text-center">Basic Web Development Course</h1>
          <div class="row mt-5 ">
           
              <img src="../pics/course1jpg.jpg" class="col-md-5 mb-4">
          
            <div class="col-md-5 ">
              <p>This course covers four essential concepts for aspiring Web Developers. This includes HTML, CSS, javascript & Bootstrap. Each section comes complete with comprehensive lessons that help students master the art of front-end coding.</p>
            </div>
          </div>
      </div>
    </section>
    ...
    <section>
      <div class="container py-2">
        ...
        <div class="col-md-5 ">
            ...
            <button class="btn btn-danger text-light float-right px-4 pt-3 mt-1"><h5>$5</h5></button>
          </div>
        </div>
          ...
          <div class="col-md-7">
            <div class="tab-content" id="nav-tabContent">
              <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-CourseC-list">
                  <ul class="mt-4">
                    <li>Introduction About web Development</li>
                    <li>Html</li>
                    <li>css</li>
                    <li>Boostrap</li>
                    <li>Javascript</li>
              ...
              <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-Sutable-list">
                <ul class="mt-5">
                  <li>The students who like to learn web development </li>
                </ul>
              </div>
              ...
              <div class="tab-pane fade" id="list-Duration" role="tabpanel" aria-labelledby="list-Duration-list">
                <ul class="mt-5">
                  <li>2 months </li>
                  <li>Monday and Thursday- 7.00pm to 9.30pm</li>
                </ul>
              </div>
              ...
              <div class="tab-pane fade" id="list-Enroll" role="tabpanel" aria-labelledby="list-Enroll-list">
                ...
                <ul class="mt-4">
                <li>Send whatsapp message to <strong>0754934562</strong> with your email ,full name and  <strong>code as c1</strong> then will be supply bank accout no  and pay to the course fee.
