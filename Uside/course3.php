    ...
    <section>
      <div class="container pt-5">
          ...
          <div class="row mt-5 ">
              ...
              <img src="../pics/cour3.png" class="col-md-5 mb-4">
          
            <div class="col-md-5 ">
              <p>Learning Python gives the programmer a wide variety of career paths to choose from. Python is an open-source (free) programming language that is used in web programming, data science, artificial intelligence, and many scientific applications. Learning Python allows the programmer to focus on solving problems, rather than focusing on syntax. Its relative size and simplified syntax give it an edge over languages like Java and C++, yet the abundance of libraries gives it
                 the power needed to accomplish great things.</p>
            </div>
          </div>
      </div>
    </section>
    ...
    <section>
      <div class="container py-2">
        ...
        <div class="col-md-5 ">
            ...
            <button class="btn btn-danger text-light float-right px-4 pt-3 mt-1"><h5>$25</h5></button>
          </div>
        </div>
            ...
            <div class="tab-content" id="nav-tabContent">
              <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-CourseC-list">
                  <ul >
                    ...
                    <li>PYTHON BOOLEAN</li>
                    <li>PYTHON OPERATORS</li>
                    <li>PYTHON COMPLEX DATA TYPES</li>
                    <li>LIST,TUPLE,SET,DICTIONARY</li>
                    <li>BASIC PROGRAMMING CONCEPTS WITH PYTHON</li>
                    <li>IF-ELSE</li>
                    <li>LOOPING</li>
              ...
              <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-Sutable-list">
                <ul class="mt-5">
                  <li>The students who like to learn python </li>
                </ul>
              </div>
              <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-Requirment-list">
                <ul class="mt-5">
                  <li>Not need knowledge basic programing language </li>
                  <li>A computer </li>
                  <li>Software will be supply</li>
                  <li>MS Teams</li>
              ...
              <div class="tab-pane fade" id="list-Duration" role="tabpanel" aria-labelledby="list-Duration-list">
                <ul class="mt-5">
                  <li>5 months </li>
                  <li>Friday,Saturday and Sunday - 7.00pm to 9.30pm</li>
                </ul>
              </div>
              ...
              <div class="tab-pane fade" id="list-Enroll" role="tabpanel" aria-labelledby="list-Enroll-list">
                ...
                <ul class="mt-4">
                <li>Send whatsapp message to <strong>0754934562</strong> with your email ,full name and  <strong>code as c3 </strong>then will be supply bank accout no  and pay to the course fee.
