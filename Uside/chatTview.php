...
<body>
    ...
    <div class="vertical-nav  bg-primary " id="sidebar">
        ...
        <ul class="nav flex-column mb-5 pb-5 " >
            ...
            <li class="nav-item">
                <a class="nav-link  text-light" href="chatTview.php"><i class="far fa-comments mr-2"></i><span>Chat
            ...
            <div class="row mr-0 justify-content-center"  id="" >
                ...
                <div class="col-md-4">
                    ...
                    <ul>
                        <?php
                            $cid=$_SESSION['c_id'];
                            $msgs = mysqli_query($con,"SELECT * FROM login,std_course WHERE login.L_Id=std_course.L_Id and `Role`='student' and `C_id`='$cid'") or die("error".mysqli_error());
                            while($msg = mysqli_fetch_assoc($msgs)){

                               
                                    echo '<a href="?toUser='.$msg['L_Id'].'" class="list-group-item list-group-item-action list-group-item-primary">'.$msg['Fname'].' </a>';
                                    ...
                                    if(isset($_GET['toUser'])){
                                        ...
                                        while($chat= mysqli_fetch_assoc($chats)){
                                                if($chat['FromUser']== $_SESSION['id']){
                                                    ...
                                                    <a class=\"btn btn-danger float-right\" href=\"../php/notice.php?l1r=\"><i class=\"fas fa-trash\" ></i></a>
                                                    ".$chat['Messages']."<br>
